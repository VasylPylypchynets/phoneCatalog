...
import { loadCard } from '../../store/slices/cardsSlice';
      ...
      <div className={styles.header__container}>
        ...
        <div className={styles.header__buttons}>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? `${styles['header__buttons-right']} ${styles['header__buttons-right--active']}`
                : `${styles['header__buttons-right']}`
            }
          >
            <div className={styles.header__numbers}>
              <div
                className={classNames(styles['header__numbers-count'], {
                  [styles['header__numbers-count--active']]:
                    favouritesLength > 0,
                })}
              >
                {favouritesLength}
          ...
          >
            <div className={styles.header__numbers}>
              <div
                className={classNames(styles['header__numbers-count'], {
                  [styles['header__numbers-count--active']]: cardsLength > 0,
                })}
              >
                {cardsLength}
              </div>
          ...
          <div
            onClick={onOpenMenu}
            className={`${styles['header__buttons-right']} ${styles['header__button-menu']}`}
          >
            <svg
              width="16"
              height="16"
